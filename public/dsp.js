...
function pitchTrack(samples,sr){return frames(samples,sr,30,40).map((x,i)=>({time:i*.04,f0:autocorrelationF0(x,sr),rms:rms(x)}))}
...
window.SV_DSP=window.SV_DSP||{};window.SV_DSP.MDVP_PARAMETER_SPEC=MDVP_PARAMETER_SPEC;
